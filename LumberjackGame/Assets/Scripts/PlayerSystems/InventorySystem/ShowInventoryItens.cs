...
public class ShowInventoryItens : MonoBehaviour
{
    ...
    [SerializeField] InventoryItemUIManager itemPrefab;
    ...
    public InventoryItemUIManager ItemPrefab { get { return itemPrefab; } set { itemPrefab = value; } }
    ...
    public void ShowItensInUI(List<InventoryItem> inventory)
    {
        ...
        if (content != null)
        {
            ...
            {
                InventoryItemUIManager newSlot = Instantiate(itemPrefab, content);
                itensPrefabed.Add(new ItemList(newSlot, InventItem));
                newSlot.FinishSettings(true, InventItem, null, 0);
                newSlot.Sii = this;
             }
...
{
    public InventoryItemUIManager ItemPrefab;
    public InventoryItem inventItem;

    public ItemList(InventoryItemUIManager itemS, InventoryItem _item)
    {
        ItemPrefab = itemS;
        inventItem = _item;
    }
